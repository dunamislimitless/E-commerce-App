...
class ProductDetail extends StatelessWidget {
  ...
  const ProductDetail({Key? key, this.moveToCart}) : super(key: key);
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                        ...
                        Flexible(
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: 8.h),
                              Text(AppString.unisex, style: AppText.regular400),
                              ...
                              Text(AppString.about, style: AppText.titleText),
                            ],
                          ),
                        ),
                        SizedBox(width: 15),
                    ...
                    Text(product.description, style: AppText.reviewText),
                    SizedBox(height: 30.h),
                    CustomButton(
                      onPressed: () {
                        context
